...
adminRouter.get(
  ...
  wrapRequestHandler(getAllBlogsAdminController)
);
adminRouter.post(
  "/blogs",
...
adminRouter.patch(
  "/blogs/:id/status",
  requirePermission("UPDATE_POST"),
  wrapRequestHandler(togglePublishController)
);
adminRouter.post(
  "/blogs/generate",
  requirePermission("CREATE_POST"),
  wrapRequestHandler(generateContentController)
);
...
adminRouter.get(
  ...
  wrapRequestHandler(getAllCategoriesAdminController)
);
adminRouter.post(
  "/categories",
...
adminRouter.get(
  ...
  wrapRequestHandler(getAllCommentsController)
);
adminRouter.patch(
  "/comments/:id/approve",
...
adminRouter.patch(
  ...
  wrapRequestHandler(updateUserInfoByAdminController)
);
adminRouter.delete(
  "/users/:id",
  requirePermission("DELETE_USER"),
  wrapRequestHandler(deleteUserByAdminController)
);
...
adminRouter.get(
  ...
  wrapRequestHandler(getAllAdminsController)
);
adminRouter.post(
  "/staffs",
  requirePermission("MANAGE_ADMIN"),
